      ...
      <header className="sticky top-0 z-40 border-b border-white/5 bg-[#0a0a0f]/95 pl-16 sm:pl-20 pr-4 sm:pr-8 py-2.5 backdrop-blur-xl">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h1 className="text-sm font-semibold leading-tight text-white">Network Monitoring Status</h1>
              <p className="text-[10px] text-slate-500">Suricata · Zeek · Wazuh · Falco</p>
            </div>
          </div>
          <Button variant="outline" size="xs" className="border-white/10 text-slate-300 hover:bg-white/5 text-xs h-7 px-2.5" onClick={() => signOut({ callbackUrl: "/" })}>
            Sign Out
          </Button>
        </div>
      </header>
