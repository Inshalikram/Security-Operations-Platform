      ...
      <header className="relative border-b border-white/5 bg-white/[0.02] pl-16 sm:pl-20 pr-4 sm:pr-8 py-2.5 backdrop-blur-xl">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h1 className="text-sm font-semibold leading-tight text-white">Organizations</h1>
              <p className="text-[10px] text-slate-500">Tenants managed on this platform</p>
            </div>
          </div>
          <Button
            variant="outline"
        ...
        {showForm && (
          <Card className="border-white/5 bg-white/[0.03] backdrop-blur-xl">
            <CardContent className="pt-6 space-y-3">
              ...
              <Button onClick={handleCreate} className="w-full bg-[#1c2e4a] hover:bg-[#243b61] text-white shadow-sm shadow-[#1c2e4a]/30 border border-[#1c2e4a]">
                Save Organization
              </Button>
            </CardContent>
          </Card>
