      ...
      <header className="relative border-b border-white/5 bg-white/[0.02] pl-16 sm:pl-20 pr-4 sm:pr-8 py-2.5 backdrop-blur-xl">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h1 className="text-sm font-semibold leading-tight text-white">Pending Approvals</h1>
              <p className="text-[10px] text-slate-500">Agent-proposed actions awaiting human review</p>
            </div>
          </div>
          <Button
            variant="outline"
