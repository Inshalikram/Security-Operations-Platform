      ...
      <header className="relative border-b border-white/5 bg-white/[0.02] pl-16 sm:pl-20 pr-4 sm:pr-8 py-2.5 backdrop-blur-xl">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h1 className="text-sm font-semibold leading-tight text-white">Cases</h1>
              <p className="text-[10px] text-slate-500">TheHive incident tracking</p>
            </div>
          </div>
          <Button
            variant="outline"
            ...
            <CardContent>
              ...
              <div className="flex flex-wrap gap-2 mb-2">
                {(c.tags || []).map((tag: string) => (
                  <span key={tag} className="text-xs px-2 py-0.5 rounded-full bg-[#1c2e4a]/60 text-slate-200 border border-[#1c2e4a]">
                    {tag}
                  </span>
                ))}
              </div>
