...
Write-Host "`n[1/4] Simulating ICMP Ping sweep..." -ForegroundColor Yellow
...
Write-Host "`n[2/4] Simulating SQL Injection probe via 'sqlmap'..." -ForegroundColor Yellow
...
Write-Host "`n[3/4] Simulating Directory Traversal probe (Nikto scanner)..." -ForegroundColor Yellow
...
Write-Host "`n[4/4] Simulating Port Scan burst (25 rapid probes to trip threshold)..." -ForegroundColor Yellow
1..25 | ForEach-Object {
